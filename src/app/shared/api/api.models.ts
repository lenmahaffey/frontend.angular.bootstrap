...
export class ConferenceVenue_DTO implements IConferenceVenue_DTO {
    ...
    constructor(data?: IConferenceVenue_DTO) {
        ...
        if (!data) {
            this.conference = new Conference_DTO();
            this.venue = new Venue_DTO();
        }
    }
    ...
    init(_data?: any) {
        if (_data) {
            ...
            this.venueId = _data["venueId"];
            this.conference = _data["conference"] ? Conference_DTO.fromJS(_data["conference"]) : new Conference_DTO();
            this.venue = _data["venue"] ? Venue_DTO.fromJS(_data["venue"]) : new Venue_DTO();
        }
    }
